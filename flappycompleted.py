...
main = pygame.transform.scale(main,(display_width,display_height))
wallpaper1= pygame.image.load('wallpaper1.jpg')
wallpaper1 = pygame.transform.scale(wallpaper1,(display_width,display_height))
wallpaper2= pygame.image.load('wallpaper2.jpg')
wallpaper2 = pygame.transform.scale(wallpaper2,(display_width,display_height))
wallpaper3= pygame.image.load('wallpaper3.jpg')
wallpaper3 = pygame.transform.scale(wallpaper3,(display_width,display_height))
...
def pause(background):
    ...
    while p:
        ...
        gamedisplay.blit(font.render("Game Paused..!!",True,black),[250,160])
...
def selectbird():
    ...
    while intro:
        ...
        blitimage(font.render("Select Bird",True,grey),display_width/2,100)

        img1 = blitimage(bird1,display_width/2-150,display_height/2-100)
        img2 = blitimage(bird2,display_width/2,display_height/2-100)
        img3 = blitimage(bird3,display_width/2+150,display_height/2-100)
...
def selectback():
    ...
    while k:
        gamedisplay.blit(main,(0,0))
        blitimage(font.render("Select Background",True,grey),display_width/2,300)

        img1 = blitimage(pygame.transform.scale(wallpaper1,(70,70)),display_width/2-150,display_height/2+100)
        img2 = blitimage(pygame.transform.scale(wallpaper2,(70,70)),display_width/2,display_height/2+100)
        img3 = blitimage(pygame.transform.scale(wallpaper3,(70,70)),display_width/2+150,display_height/2+100)
...
def gameloop():
    ...
    while not gameexit:
            ...
            while gameover:
                gamedisplay.blit(font.render("Game Over..!!",True,red),[250,175])
